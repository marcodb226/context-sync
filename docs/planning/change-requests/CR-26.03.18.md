# CR-26.03.18 - Split the Refresh-Contract Amendment out of M1-D1
...
<a id="cr-26.03.18-proposed-m1-d3"></a>
...
- Decide and document whether
  ...
  [M1-D3](#cr-26.03.18-proposed-m1-d3), or whether the existing
...
- Define the first-release relation freshness contract explicitly. Because
  ...
  [M1-D3](#cr-26.03.18-proposed-m1-d3) must require `refresh` to detect relation
...
- if the issue-level `updated_at` contract fails, [M1-D1](../../implementation-plan.md#m1-d1---refresh-freshness-validation-spike)
  ...
  refresh-design rewrite is performed in [M1-D3](#cr-26.03.18-proposed-m1-d3) rather
...
to depend on
[M1-D3](#cr-26.03.18-proposed-m1-d3).
...
[M1-D3](#cr-26.03.18-proposed-m1-d3) is settled.
...
- Risk register mitigation for [OQ-1](../../adr.md#oq-1-refresh-freshness-validation-against-live-linear-behavior):
  ...
  for validation plus [M1-D3](#cr-26.03.18-proposed-m1-d3)
  for the governing design response.
- If [M1-D3](#cr-26.03.18-proposed-m1-d3) rewrites the ADR refresh-strategy prose in
  [docs/adr.md](../../adr.md#52-refresh-incremental-whole-snapshot-update),
...
- The review and owner-response record remains in
  [docs/planning/change-requests/CR-26.03.18-review.md](CR-26.03.18-review.md).
