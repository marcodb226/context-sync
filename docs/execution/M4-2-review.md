...
| M4-2-R3 | Future work | A manual smoke-test procedure requires a working CLI against real Linear, which is blocked on the real gateway adapter. A smoke-test recipe cannot be meaningfully written or verified until that path exists. |
